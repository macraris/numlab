...
const MANUALE = JSON.parse(fs.readFileSync(path.join(__dirname, 'data', 'manuale_math.json'), 'utf-8'));
const APPENDICE = JSON.parse(fs.readFileSync(path.join(__dirname, 'data', 'appendice_math.json'), 'utf-8'));
